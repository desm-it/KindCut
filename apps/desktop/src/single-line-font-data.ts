// AUTO-GENERATED from the public-domain Hershey "futural" (Sans 1-stroke) font.
// Each entry is ASCII code (32 + index). Format: chars are pairs; value = charCode - 82 (R).
// Pair 0 = left/right bounds (advance); a pair starting with a space is a pen-up (new stroke).
// Source: github.com/kamalmostafa/hershey-fonts (futural.jhf), public domain.
export const HERSHEY_FUTURAL: readonly string[] = [
  "JZ",
  "MWRFRT RRYQZR[SZRY",
  "JZNFNM RVFVM",
