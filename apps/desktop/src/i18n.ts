...
const translations = {
  nl: {
    ...
    "import.title": "Haal een SVG-ontwerpbestand binnen",
    "import.description":
      "Kies een SVG-ontwerpbestand van deze computer. KindCut toont een rustige preview en een duidelijke controle voordat iets voor een snijmachine wordt voorbereid.",
    "import.empty": "Nog geen SVG gekozen. Begin met een bestand dat je al hebt; KindCut toont het dan hier.",
    "import.chooseSvgFile": "Kies eerst een SVG, daarna kan KindCut het voorbereiden.",
    ...
    "import.planError": "KindCut kon die SVG nog niet voorbereiden.",
    ...
    "import.readyMessage": "KindCut kan deze SVG lezen en in de preview tonen.",
    ...
    "plan.importedPanelLabel": "Overdracht van geïmporteerde SVG",
  ...
  en: {
    ...
    "import.title": "Bring in an SVG design file",
    "import.description":
      "Pick an SVG design file from this computer. KindCut will show a gentle preview and a plain-English check before anything is prepared for a cutter.",
    "import.empty": "No SVG chosen yet. Start with a file you already have, then KindCut will show it here.",
    "import.chooseSvgFile": "Choose an SVG first, then KindCut can prepare it.",
    ...
    "import.planError": "KindCut could not prepare that SVG yet.",
    ...
    "import.readyMessage": "KindCut can read this SVG and show it in the preview.",
    ...
    "plan.importedPanelLabel": "Imported SVG handoff",
